...
from elementum.util import notify, dialog_ok, system_information, getLocalizedString, getWindowsShortPath
...
def get_elementum_binary():
    binary = "elementum" + (PLATFORM["os"] == "windows" and ".exe" or "")
    ...
    log.info("Get Binary detection premature: %s, %s" % (dest_binary_dir, dest_binary_path))
...
def shutdown():
    try:
        urllib2.urlopen(ELEMENTUMD_HOST + "/shutdown")
    except:
        pass
